...
const iconFirewall = new URL('../../icons/nodes/Firewall.svg', import.meta.url).href;
const iconStorage = new URL('../../icons/nodes/StorageContainer.svg', import.meta.url).href;
